...
/**
 * Utility class for multiplying BigIntegers quickly, using the Karatsuba
...
public final class KaratsubaMultiplication
{
	...
	/**
	 * Returns {@code x * y}, the product of the specified integers. This gives
	 * the same result as {@code x.multiply(y)} but should be faster.
	 * 
	 * @param x
	 *            a multiplicand
	 * @param y
	...
	public static BigInteger multiply(BigInteger x, BigInteger y)
	{
		...
		else
		{
			...
			int half = (n + 32) / 64 * 32; // Number of bits to use for the low
											// part
