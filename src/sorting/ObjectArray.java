...
public class ObjectArray
{
	...
	public static void sort(Object[] a, boolean usingMergeSort)
	{
		if (usingMergeSort)
			legacyMergeSort(a);
		else
	...
	public static void sort(Object[] a, int fromIndex, int toIndex, boolean usingMergeSort)
	{
...
class ComparableTimSort
{
	...
	private void mergeLo(int base1, int len1, int base2, int len2)
	{
		...
		if (len1 == 1)
		{
			...
			a[dest + len2] = tmp[cursor1]; // Last elt of run 1 to end of
											// merge
			return;
		}

		int minGallop = this.minGallop; // Use local variable for
										// performance
		outer: while (true)
		{
	...
	private void mergeHi(int base1, int len1, int base2, int len2)
	{
		...
		if (len2 == 1)
		{
			...
			cursor1 -= len1;
			System.arraycopy(a, cursor1 + 1, a, dest + 1, len1);
			a[dest] = tmp[cursor2]; // Move first elt of run2 to front of
									// merge
		}
		else if (len2 == 0)
		{
