...
public final class StdRandom
{
	 ...
	 *             if <tt>probabilities</tt> is <tt>null</tt>
	 * @throws IllegalArgumentException
	 *             if sum of array entries is not (very nearly) equal to
	 *             <tt>1.0</tt>
	 * @throws IllegalArgumentException
	 *             unless <tt>probabilities[i] >= 0.0</tt> for each index
	 *             <tt>i</tt>
	 */
	 ...
	 * @throws NullPointerException
	 *             if <tt>frequencies</tt> is <tt>null</tt>
	 * @throws IllegalArgumentException
	 *             if all array entries are <tt>0</tt>
	 * @throws IllegalArgumentException
	 *             if <tt>frequencies[i]</tt> is negative for any index
	 *             <tt>i</tt>
	 * @throws IllegalArgumentException
	 *             if sum of frequencies exceeds <tt>Integer.MAX_VALUE</tt> (2
	 *             <sup>31</sup> - 1)
	 */
	 ...
	 *             unless <tt>(0 <= lo) && (lo <= hi) && (hi < a.length)</tt>
	 * 
	 */
