 ...
 * the ArrayCopier do not have to be reallocated as often. When performing an
...
class MutableBigInteger
{
	...
	{
		intLen = b.mag.length;
		value = ArrayCopier.copyOf(b.mag, intLen);
	}
	...
	{
		intLen = val.intLen;
		value = ArrayCopier.copyOfRange(val.value, val.offset, val.offset + intLen);
	}
	...
	private int[] getMagnitudeArray()
	{
		if (offset > 0 || value.length != intLen)
			return ArrayCopier.copyOfRange(value, offset, offset + intLen);
		return value;
	}
	...
	MutableBigInteger divide(MutableBigInteger b, MutableBigInteger quotient)
	{
		...
		int[] div = ArrayCopier.copyOfRange(b.value, b.offset, b.offset + b.intLen);
